...
def main():
    ...
    angulo_graus= float(input("Digite o ângulo, em graus, do plano inclinado: "))
    ...
    while True:
        ...
        print("3- Visualizar a aceleração inicial do sistema")
        ...
        match opcao:
            ...
            case "4":
                ...
                angulo_graus = float(input("Digite o novo ângulo (graus): "))
